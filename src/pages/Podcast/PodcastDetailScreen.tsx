  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setError("Không th? t?i thông tin podcast.");
      } finally {
        setLoading(false);
      }
    };
  ...
  if (error || !podcast) {
    return (
      <div className="pdd">
        <div className="pdd-state">
          <Music2 size={28} />
          <p>{error || "Không tìm th?y podcast."}</p>
      ...
      <section className="pdd-episodes">
        ...
        {episodes.length === 0 ? (
          <div className="pdd-empty">
            <Music2 size={24} />
            <p>Podcast này chua có t?p nào.</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <button
                    ...
                    title={ep.audioUrl ? (isPlaying ? "T?m d?ng" : "Phát") : "Chua có audio"}
                  >
