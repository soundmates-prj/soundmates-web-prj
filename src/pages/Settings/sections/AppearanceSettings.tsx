...
export default function AppearanceSettings() {
  ...
  const [isPremium, setIsPremium] = useState<boolean | null>(null); // null = đang tải
              ...
              return (
                <div key={t.id} style={{ position: "relative" }}>
                  <button
                    ...
                    title={locked ? "Cần nâng cấp Premium để sử dụng theme này" : t.name}
                  >
                    ...
                    <div className="theme-option-content">
                      ...
                      <span className="theme-option-desc">
                        {locked ? "🔒 Chỉ dành cho Premium" : `Chế độ: ${t.mode === "dark" ? "Tối" : "Sáng"}`}
                      </span>
                    </div>
                    {isActive && !locked && (
          ...
          >
            ...
            <div>
              <p style={{ margin: 0, fontWeight: 700, color: "#f59e0b", fontSize: "0.95rem" }}>
                Nâng cấp Premium để mở khóa tất cả chủ đề
              </p>
