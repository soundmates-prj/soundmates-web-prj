  ...
  return (
    <div className="admin-system-settings">
      ...
      <div className="admin-system-grid">
        ...
        <div className="admin-system-card">
          <div className="admin-system-card-title">Cấu hình</div>
          {loadingConfig ? (
        ...
        <div className="admin-system-card">
          <div className="admin-system-card-title">Kiểm tra kết nối</div>
          <button
      ...
      <div className="admin-system-card" style={{ marginTop: 16 }}>
        ...
        <div className="ops-stack" style={{ gap: 12 }}>
          ...
          <div>
            ...
            />
            {baseUrlError && (
              <p style={{ color: "#ef4444", fontSize: 12, margin: "4px 0 0" }}>{baseUrlError}</p>
            )}
          </div>
          ...
          <div>
            ...
            {apiKeyError && (
              <p style={{ color: "#ef4444", fontSize: 12, margin: "4px 0 0" }}>{apiKeyError}</p>
            )}
          </div>
